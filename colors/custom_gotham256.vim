...
set background=dark
let g:colors_name = 'custom_gotham256'
...
let s:colors.base3 = { 'gui': '#503749', 'cterm': 236  }
...
" Other colors.
let s:colors.red     = { 'gui': '#c23127', 'cterm': 160 }
...
" Tab line.
call s:Col('TabLineSel', 'base0', 'base5')  " the selected tab
